...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/6a9e7882ec3f48b18e496e0a38ee02e3", // <---- YOUR INFURA ID! (or it won't work)
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/6a9e7882ec3f48b18e496e0a38ee02e3", // <---- YOUR INFURA ID! (or it won't work)
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/6a9e7882ec3f48b18e496e0a38ee02e3", // <---- YOUR INFURA ID! (or it won't work)
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/6a9e7882ec3f48b18e496e0a38ee02e3", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      url: "https://goerli.infura.io/v3/6a9e7882ec3f48b18e496e0a38ee02e3", // <---- YOUR INFURA ID! (or it won't work)
  ...
  etherscan: {
    apiKey: "EQI4JUCP6SPCEMHP5E7HDVPC11D2NWB6Y4",
  },
};

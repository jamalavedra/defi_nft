...
export function Web3Provider({ children, ...props }) {
  ...
  const kovanInfura = useMemo(() => {
    if (DEBUG) console.log("📡 Connecting to Kovan Ethereum");
    return navigator.onLine
      ? new ethers.providers.StaticJsonRpcProvider(`https://eth-kovan.alchemyapi.io/v2/${ALCHEMY_KEY}`)
      : null;
  }, [navigator.onLine]);
